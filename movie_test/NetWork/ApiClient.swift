...
class APIClient: NowPlayingAPIService, APIUpcomingService, APITopRatedService, SearchAPIService {
    ...
    func getUpcomingMovies(service: Service, completion: @escaping (APIResponse<NowPlayingResponse>) -> ()) {
        self.request(type: NowPlayingResponse.self, service: service, completion: completion)
    }
    func getTopRatedMovies(service: Service, completion: @escaping (APIResponse<NowPlayingResponse>) -> ()) {
        self.request(type: NowPlayingResponse.self, service: service, completion: completion)
    }
